public class Immutable {
    public static void main(String[] args) {        
        ...
        //applesWrapper is a basket that could be holding apples or could be completely empty, meaning the object doesn't contain anything at all (null). Immutable objects can be null, just like a basket can be empty.
